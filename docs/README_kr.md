...
### shared-core 모듈
- [Shared Core](https://monkshark.github.io/page-ide/#modules/shared-core/main.md) — 데스크톱·wasm 뷰어 공용 멀티플랫폼 기반 (마크다운·JSON 파서, 그래프 모델, FilePath)
...
### atlas-view 모듈
- [Atlas View](https://monkshark.github.io/page-ide/#modules/atlas-view/main.md) — overview 그래프 모델·렌더 (데스크톱·문서 뷰어 공용 멀티플랫폼)
...
### docs-viewer 모듈
- [Docs Viewer](https://monkshark.github.io/page-ide/#modules/docs-viewer/main.md) — 이 문서 사이트를 그리는 Compose wasmJs 앱과 위젯 섬
